...
import static com.nightcrawler.news.Database.newsContract.newsContractEntry.TABLE_NAME;
...
public class FavNewsContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(newsContract.AUTHORITY, newsContract.PATH_TASKS, TASKS);
        uriMatcher.addURI(newsContract.AUTHORITY, newsContract.PATH_TASKS + "/#", TASK_WITH_ID);
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case TASKS:
                ...
                if (id > 0) {
                    returnUri = ContentUris.withAppendedId(newsContract.newsContractEntry.CONTENT_URI, id);
                } else {
